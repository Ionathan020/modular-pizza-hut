...
public class DeliveringOfPizzaRepositoryAdapter implements DeliveringOfPizzaRepository {
    private static final Logger logger = LoggerFactory.getLogger(DeliveringOfPizzaRepositoryAdapter.class);
    private final DeliveryOfPizzaJPARepository deliveryOfPizzaJPARepository;

    public DeliveringOfPizzaRepositoryAdapter(DeliveryOfPizzaJPARepository deliveryOfPizzaJPARepository) {
